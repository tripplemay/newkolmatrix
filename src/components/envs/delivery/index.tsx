// ARCH-M05 F007 — Delivery 环节落地面占位 stub（挂载契约：default export + { projectId }）。
// F011 实装「条件台账」语法面（V7 11 元素）时整体替换本文件；五套语法互不相同（D8/FR-7.10）。
// 反向 guardrail 预告：本环节刻意无 KPI/图表/推荐卡/批量按钮（D8），实装时不得补。
