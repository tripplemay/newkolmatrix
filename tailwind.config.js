  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        smartHomeDropzone: `url("data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='13' ry='13' stroke='%23E0E5F2FF' strokeWidth='4' strokeDasharray='6%2c 14' stroke-dashoffset='5' strokeLinecap='square'/%3e%3c/svg%3e")`,
      },
    },
    screens: {
      sm: '576px',
